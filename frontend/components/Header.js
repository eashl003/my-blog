...
const Header = ({ categories = [], blogs = [] }) => {
  ...
  return (
    ...
    <div className="flex-1 flex justify-between items-center text-white text-bold">
      <a href="/"> test</a>
    </div>
    ...
    <div className="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
      <nav>
        <ul className="lg:flex items-center justify-between pt-4 ml-10 lg:pt-0"> 
          <div id="dropdown">
          <a id="blog-link" className=" text-white font-bold hover:text-indigo-400" href="/blog">Blog</a>
        ...
        <div id="dropdown">
          <a className="text-white font-bold hover:text-indigo-400" href="/shop">Shop</a> 
          <ul id="dropdown-content">
          ...
          <li><a className="lg:p-4 py-3 px-0 block hover:text-indigo-400 font-bold text-white" href="/about">About</a></li>
